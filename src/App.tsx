...
export default function App() {
  ...
  const DraftRankingVisual = () => {
    ...
    return (
      <div className="chartbox compactrankingbox">
        <div className="charthead">
          <div>
            <div className="glabel">DRAFT BY FIFA RANKING</div>
            <div className="subtle">Compact view of every team by FIFA ranking and owner</div>
          </div>
        </div>
        ...
        <section className="pane">
          ...
          {filtersOpen && (
            <div className="filterpanel">
              ...
              />
              <button
                className={`clearfilterbtn todayfilterbtn ${resultDateFilter === todayKey ? "active" : ""}`}
                onClick={() => setResultDateFilter(resultDateFilter === todayKey ? "" : todayKey)}
                type="button"
              >
                Today
              </button>
