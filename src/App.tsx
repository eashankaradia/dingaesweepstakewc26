        ...
        <div className="rankinglist">
          {ranked.map((tid) => {
            ...
            return (
              ...
              >
                <span className="ranknum">#{FIFA_RANKINGS[tid] || "—"}</span>
...
.rankinglist{display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:7px}.rankingrow{display:grid;grid-template-columns:44px 1fr auto;gap:8px;align-items:center;background:#0C1F15;border:1px solid #ffffff12;border-left:4px solid #ffffff22;border-radius:8px;padding:8px 9px;font-size:12px}.ranknum{font-family:'Saira Condensed';font-weight:800;color:#E8B33B;font-size:16px}.rankteam{font-weight:700}.rankowner{font-size:11px;color:#C8D8CC}.mystatcards{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px;margin:10px 0 12px}.mystatcard{border:1px solid #ffffff22;border-radius:12px;padding:12px;display:flex;flex-direction:column;gap:4px}.mystatcard span{font-size:11px;color:#C8D8CC;text-transform:uppercase;letter-spacing:.08em}.mystatcard b{font-family:'Saira Condensed';font-size:30px;line-height:1;color:#F0EDE2}.calendarlist{display:flex;flex-direction:column;gap:8px}.calendarday{background:#0C1F15;border:1px solid #ffffff12;border-radius:10px;padding:9px}.calendarday>b{display:block;font-family:'Saira Condensed';color:#E8B33B;font-size:17px;text-transform:uppercase;letter-spacing:.06em;margin-bottom:6px}.calendarday>div{display:flex;flex-wrap:wrap;gap:6px}.calendarpill{border:1px solid #ffffff18;background:#10271A;border-radius:999px;padding:5px 8px;font-size:11.5px;color:#C8D8CC}.calendarpill.done{border-color:#E8B33B66}.calendarpill.live{border-color:#E0635C88;color:#F0EDE2}.calendarpill.future{opacity:.8}@media(max-width:560px){.mystatcards{grid-template-columns:1fr}.rankingrow{grid-template-columns:42px 1fr}.rankowner{grid-column:2}}
